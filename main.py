...
g.add_button(labels[4], (0, (h * len(g.get_buttons()))), callback=e.on_check_2_vertex_adjacency)
...
g.add_button(labels[7], (0, (h * len(g.get_buttons()))), callback=e.on_return_edge_2_vertex_references)
